  ...
  memories: [
    {
      ...
      note: 'The petals were falling like pink snow that afternoon. You turned around with that radiant smile, and I wished time could freeze forever.',
    },
    {
      id: 'mem-2',
      ...
      note: 'Walking side by side in the cool night breeze. We drank warm matcha and talked for hours about the adventures we would have together.',
    },
    {
      id: 'mem-3',
      ...
      year: '2024',
      location: 'Kamakura',
      note: 'The gentle sound of rain on the wooden veranda, the steam rising from our cups, and a quiet sense of peace that only your presence can bring.',
    },
    {
      id: 'mem-4',
      ...
      note: 'Waking up at 5 AM in the biting cold was totally worth it when we saw the sun tint Mount Fuji in soft gold and rose.',
    },
    {
      id: 'mem-5',
      ...
      year: '2025',
      location: 'Arashiyama',
      note: 'Sunlight filtering through towering green stalks. You laughed as the wind made the bamboo hum like an ancient melody.',
    },
    {
      id: 'mem-6',
      ...
      year: '2026',
      location: 'Tokyo',
      note: 'Here is to your 25th chapter! May every step ahead be guided by warmth, happiness, and all the love in the universe. 🌸🎂',
    },
  ],
  timeline: [
    {
